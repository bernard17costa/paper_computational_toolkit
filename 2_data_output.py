...
def main():
  filename = "1_collected_data.csv"  # Change this to your CSV file name
  columns = convert_columns(read_csv_columns(filename))

  output_file = open('data_output1' + '.csv', 'w', newline='')
  ...
  output_file = open('data_output2' + '.csv', 'w', newline='')
  output_file.write('comportamento')
  output_file.write(' \t')
  output_file.write('cadeia')
  output_file.write(' \t')
  ...
  output_file = open('data_output3' + '.csv', 'w', newline='')
  output_file.write('comportamento')
  output_file.write(' \t')
  output_file.write('cadeia')
  output_file.write(' \t')
