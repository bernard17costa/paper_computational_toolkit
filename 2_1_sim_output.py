...
#
# Description:
# This script processes the output of behavioral simulations
# ("1_sim_behaviors_surrogates_output.csv") and computes:
#
...
#     2_1_sim_output1.csv → behavioral + correlation metrics
#     2_1_sim_output2.csv → M0 structure
#     2_1_sim_output3.csv → M2 structure
###########################################################
import numpy as np
import random
import csv
...
def delete():
  if os.path.isdir('temp'):
    ...
    os.makedirs('temp')
  input_file = open('1_sim_behaviors_surrogates_output.csv', 'r')
...
def main():
  ...
  filename = "temp/behaviors_surrogates_4.csv"
  columns = convert_columns(read_csv_columns(filename))

  output_file = open('2_1_sim_output1' + '.csv', 'w', newline='')
  ...
  output_file = open('2_1_sim_output2' + '.csv', 'w', newline='')
  output_file.write('behaviour')
  output_file.write(' \t')
  output_file.write('sequence')
  output_file.write(' \t')
  ...
  output_file = open('2_1_sim_output3' + '.csv', 'w', newline='')
  output_file.write('behaviour')
  output_file.write(' \t')
  output_file.write('sequence')
  output_file.write(' \t')
