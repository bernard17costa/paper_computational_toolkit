...
#     2_3_data_output1.csv → behavioral + correlation metrics
...
def main():
  filename = "2_2_collected_data_surrogate.csv"
  ...
  filename = "2_2_collected_data_surrogate.csv"  # Change this to your CSV file name
  columns = convert_columns(read_csv_columns(filename))
